...
internal static class WorkflowCodeGenerator
{
	...
	public static string Generate(WorkflowModel workflow)
	{
		...
		sb.AppendLine("/// </summary>");
		sb.AppendLine($"public partial class {className} : Workflow");
		sb.AppendLine("{");
	...
	{
		sb.AppendLine("\tpublic override JsonNode Build()");
		sb.AppendLine("\t{");
		...
		if (parameters.Count > 0)
		{
			...
			sb.AppendLine("\t\treturn JsonNode.Parse(json)!;");
		}
		else
		{
			sb.AppendLine("\t\treturn JsonNode.Parse(TemplateJson)!;");
		}
